...
const suspectsArray = [
    ...
    },
    {
        ...
        age: 26,
        description:'PhD in plant toxicolody. Adopted caughter of Mr. Boddy.',
...
function selectRandom(arrRt) {
    if (arrRt.length === 0) {
        return undefined;
    }
    let randomWeapon =  Math.floor(Math.random() * arrRt.length);
    //let choseArr = weaponsArray[randomWeapon];
  return arrRt[randomWeapon];
}
...
// let mysteryToSee = pickMystery()
// console.log(mysteryToSee)
